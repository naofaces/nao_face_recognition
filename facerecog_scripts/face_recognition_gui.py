...
class FaceRecognitionGui(QtGui.QMainWindow):
    ...
    # holder for nao stream
    # TODO change to non-list variable?
    pix_holder = []
    ...
    def create_widgets(self):
        # all other components are added to main_grid
    ...
    def create_control_panel(self, main_grid):
        ...
        # Connecting buttons with handler methods from GUI
    ...
    def create_list_panel(self, main_grid):
    ...
    #     al_image = self.videoProxy.getImageRemote(self.imgClient)
    #     self.current_image[0] = QImage(al_image[6],  # Pixel array.
    #                                 al_image[0],  # Width.
    #                                 al_image[1],  # Height.
    ...
    def update_text_area(self):
        ...
        # else:
        #     for name, count in self.people, self.image_count_persons:
        #         text += name + ' \n'
        #         #text += name + '    (' + str(count) + ' images)\n'
        #         print 'Name is ' + name
